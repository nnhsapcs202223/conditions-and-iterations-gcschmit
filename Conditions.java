...
public class Conditions
{
    public static void ifExample()
    {
        ...
        // model the roll of a four-side die [1-4]
    ...
    public static boolean doublesAreEqual(double num1, double num2)
    {
         ...
         *      binary bits match.
         *  For "equal" number, this is probably not the case due to floating-point rounding
    ...
    public static void stringExample()
    {
        ...
        /*
         * The equality operator (==) returns true if the two variables (e.g., str1
         *      and str2) contain the same value. For variables of a class type, including
        ...
        /*
         * If we want to check if strings are not equals, we use the logical complement
         *      operator (i.e., !)
         */
        if( ! str1.equals(str2))
        {
