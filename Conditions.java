...
public class Conditions
{
    ...
    public static void stringExample()
    {
        ...
        /*
         * The equality operator (==) returns true if the two variables (e.g., str1 and
         *      str2) contain the same value. For variables of a class type, including String,
         *      this means that they contain the same reference. That is, they refer to the
         *      same object in memory, not that the two strings have the same sequence
         *      of characters.
         */
        if(str1 == str2)
        {
